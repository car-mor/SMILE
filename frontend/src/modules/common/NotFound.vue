<template>
  ...
  >
    ...
    >
      <p class="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-black">404</p>
      <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-black mt-2">
    ...
    <div class="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
      ...
      >
        ...
        <circle cx="212.59226" cy="103" r="64" fill="#ffa361"></circle>
        <path
        ...
        <ellipse
          ...
          fill="#c1a379"
        ></ellipse>
        <ellipse cx="892.44491" cy="726.79663" rx="94.98858" ry="4.80162" fill="#c1a379"></ellipse>
        <ellipse cx="548.71959" cy="773.11422" rx="94.98858" ry="4.80162" fill="#c1a379"></ellipse>
        <ellipse
          cx="287.94432"
          cy="734.27887"
          rx="217.01436"
