<template>
  <div class="h-screen xl:w-3/4 w-screen absolute bg-[#FFEEE5] flex flex-col items-center">
    <div class="mt-14 text-center flex flex-col items-center">
      <h1 class="lg:pt-4 pt-14 text-5xl w-auto sm:w-[500px] md:w-[640px] text-stone-500">
        Refuerza tus habilidades con actividades recreativas
      </h1>

      <!-- Diseño para pantallas grandes -->
      <div
        class="hidden lg:flex flex-col mt-12 ml-8 items-center md:mt-10 w-screen bg-[#FFEEE5] pb-14"
      >
        <div class="flex flex-row justify-center space-x-8">
          ...
          <img class="h-64" src="@/assets/imgs/games/juegosDiamante.png" alt="Resiliencia rápida" />
          <div>
        ...
        <div class="flex flex-row justify-center space-x-8 mt-8">
          <img class="h-64" src="@/assets/imgs/games/juegosGorro.png" alt="Elevación anímica" />
          <div>
          ...
          <img class="h-64" src="@/assets/imgs/games/juegosMedalla.png" alt="Laberinto emocional" />
          <div>
      ...
      <div class="lg:hidden mt-12 w-full flex flex-col bg-[#FFEEE5] items-center">
        <div class="w-3/4">
          <div class="h-full carousel carousel-vertical rounded-box space-y-8">
