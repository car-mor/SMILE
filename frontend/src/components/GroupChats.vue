      ...
      <div class="w-full px-5 flex flex-col justify-between">
        <div class="flex flex-col mt-5">
          ...
          <div class="flex justify-start mb-4">
            ...
            >
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat at praesentium, aut
              ullam delectus odio error sit rem. Architecto nulla doloribus laborum illo rem enim
